...
# ╔═╡ 317c84a0-9c1e-11ee-10d2-491af58289b2
begin
...
# ╔═╡ d1fd9de6-b70c-4074-b4e6-a43ab17de574
# ╠═╡ disabled = true
#=╠═╡
	begin
...
# ╔═╡ f12dd674-e849-4b2c-9cd4-9c0c45a34bb4
#=╠═╡
begin
...
# ╔═╡ 8ea5f5a6-56e9-4b4f-99b1-2c621ad76ea5
# ╠═╡ disabled = true
#=╠═╡
begin
...
# ╔═╡ 3726d884-758e-4abd-9503-5e65610eb162
# ╠═╡ disabled = true
#=╠═╡
...
# ╔═╡ c971f598-c3f3-4041-b3c0-6f3cb19fe0af
# ╠═╡ disabled = true
#=╠═╡
begin
...
# ╔═╡ 50f8054a-cad5-4979-a047-8afeff2b0643
# ╠═╡ disabled = true
#=╠═╡
# строим график:
...
# ╔═╡ d0ad1e10-aea5-406e-984e-d573248b13ee
# ╠═╡ disabled = true
#=╠═╡
plot(sol,vars=(1,2), color="black", xaxis="Жертвы",yaxis="Хищники", legend=false)
  ╠═╡ =#

# ╔═╡ 2c132004-483f-4325-9a8b-454030ce149f
# ╠═╡ disabled = true
#=╠═╡
begin
...
# ╔═╡ 51590d6d-3e71-44f4-910a-a54f190db74e
# ╠═╡ disabled = true
#=╠═╡
plot(sol, label = ["численности изолированной популяции x(t)"], color="black", ls=[:solid :dash], title="Модель Мальтуса", xaxis="Время",yaxis="Размер изолированной популяции")
  ╠═╡ =#

# ╔═╡ 2340a3fa-afbe-4e15-804a-f84a813ffba4
# ╠═╡ disabled = true
#=╠═╡
animate(sol, fps=7, "Malthus.gif", label = "численности изолированной популяции x(t)", color="black", ls=[:solid :dash], title="Модель Мальтуса", xaxis="Время",yaxis="Размер изолированной популяции")
  ╠═╡ =#

# ╔═╡ 83670286-3b4a-4fe3-9b4e-6332f9325725
# ╠═╡ disabled = true
#=╠═╡
begin
...
# ╔═╡ fc21978b-b02e-4915-9444-a45312cfa6f8
# ╠═╡ disabled = true
#=╠═╡
plot(sol, label = ["численности популяции x(t)"], color="black", ls=[:solid :dash], title="Логическая модель роста популяции", xaxis="Время",yaxis="Размер  популяции")
  ╠═╡ =#

# ╔═╡ 522335bd-f3df-4aee-965d-59d9331f6cb1
# ╠═╡ disabled = true
#=╠═╡
animate(sol, fps=7, "Logistic.gif", label = "численности  популяции x(t)", color="black", ls=[:solid :dash], title="Логическая модель роста популяции", xaxis="Время",yaxis="Размер изолированной популяции")
  ╠═╡ =#

# ╔═╡ 82829118-8db5-4473-8089-249b57cababd
# ╠═╡ disabled = true
#=╠═╡
begin
...
# ╔═╡ b90760f2-a555-47be-81a0-42ea0927f187
# ╠═╡ disabled = true
#=╠═╡
plot(sol, label = ["Восприимчивые" "Инфицированные" "Переболевшие"], color=["black", "blue", "red"], ls=[:solid :dash :dot], title="модель SIR", xaxis="Время",yaxis="Размер  популяции")
  ╠═╡ =#

# ╔═╡ 6bacf911-ec71-400d-80d2-0a28d43575c3
# ╠═╡ disabled = true
#=╠═╡
animate(sol, fps=7, "SIR.gif", label = ["Восприимчивые" "Инфицированные" "Переболевшие"],  color=["black", "blue", "red"], ls=[:solid :dash :dot], title="модель SIR", xaxis="Время",yaxis="Размер  популяции")
  ╠═╡ =#

# ╔═╡ a82baa0d-d8fa-4b3d-b72d-edda90b95d05
# ╠═╡ disabled = true
#=╠═╡
begin
...
# ╔═╡ 5e5e4c32-153a-4bc5-81e9-38852a397444
# ╠═╡ disabled = true
#=╠═╡
begin
	n = 100
...
# ╔═╡ cde73256-51ba-4d5c-be77-452863e6e415
M = 1.0

# ╔═╡ fd6cea58-84f8-44f9-8821-c8b00f5e255d
# ╠═╡ disabled = true
#=╠═╡
...
# ╔═╡ 94f939a9-d70d-43f0-aa2a-4615ba858d20
# ╠═╡ disabled = true
#=╠═╡
animate(sol, fps=7, "Competitive.gif", label = ["1-ый биологический вид" "2-ой биологический вид"], color=["purple" "green"], ls=[:solid :dash], 
    title="Модель роста популяции в условиях конкуренции",
    xaxis="Время",yaxis="Размер популяции")
  ╠═╡ =#

# ╔═╡ 7c097a68-0e98-4087-a694-e1ce8ffbc8cd
# ╠═╡ disabled = true
#=╠═╡
...
# ╔═╡ fa0a6ff1-f45e-4f7b-80a2-b7293e8e0e7e
# ╠═╡ disabled = true
#=╠═╡
plot(sol, vars=(1,2), color="black",  title="Фазовый портрет", xaxis="x(t)", yaxis="dx(t)", legend=false)
  ╠═╡ =#

# ╔═╡ 3a6655d5-1f37-4f2f-8417-7d58b54a722e
# ╠═╡ disabled = true
#=╠═╡
...
# ╔═╡ 1dae3d3d-e640-4dd1-9207-78a8e59c0f8f
...
# ╔═╡ de7e92d8-5771-4861-91f2-e5a58857afee
# ╠═╡ disabled = true
#=╠═╡
begin
...
# ╔═╡ 2bdf9f72-d81a-49a7-a4ce-6581635bfc7c
begin
...
# ╔═╡ eba80e5f-ef5c-4142-86f0-51d0849c3c37
# ╠═╡ disabled = true
#=╠═╡
begin
	# задаём описание модели:
...
# ╔═╡ 3b41d9ed-50fb-4a63-9a62-5c6941720d66
# ╠═╡ disabled = true
#=╠═╡
begin
	# задаём знанчения параметров:
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "a0542d7437a0839ac255a438fd74562504368cc1"
